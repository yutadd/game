...
public class Game extends Thread implements MouseListener,KeyListener{
	...
	public static void init() {
		...
		scorebord.setBounds(1600,0,500,100);
		scorebord.setText("0");
		scorebord.setFont(new Font("メイリオ",Font.PLAIN,30));
		panel.add(scorebord);
		ziki=new JTextArea();
		ziki.setText("〇");
		ziki.setFont(new Font("メイリオ",Font.PLAIN,100));
		ziki.setForeground(Color.red);
	...
	public void run() {
		...
		while(true){
			scorebord.setText("SCORE : "+String.valueOf(score));
			...
			panel.getGraphics().drawLine((int)panel.getMousePosition().getX()+1, (int)panel.getMousePosition().getY(), (int)ziki.getLocation().getX()+51,(int) ziki.getLocation().getY()+50);
			panel.getGraphics().drawLine((int)panel.getMousePosition().getX()-1, (int)panel.getMousePosition().getY(), (int)ziki.getLocation().getX()+49,(int) ziki.getLocation().getY()+50);
			try {
